...
<body>
		...
		<div class="container">
			<div class="row fullscreen d-flex align-items-center">
				<div class="banner-content col-lg-6 col-md-12 justify-content-center ">
					...
					<h1 class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="1.7s">Raden Saleh</h1>
					<div class="designation mb-50 wow fadeInUp" data-wow-duration="1s" data-wow-delay="2.1s">
						Software
						<span class="developer">Developer</span> and
            Graphic<span class="designer"> Designer</span>
			...
			<div class="row align-items-center justify-content-between">
				...
				<div class="col-lg-5 col-md-12 about-right">
					<div class="section-title">
						<h2><span class="fas fa-info-circle"></span> About Myself</h2>
					</div>
					<div class="mb-50 wow fadeIn" data-wow-duration=".8s">
						<p>
							 Hai, i'am Raden Muhammad Saleh Idris
              <br>Software Developer from Cirebon, Indonesia
						</p>
            <p>

            </p>
						<p>
              Now i'am a College Student in Software Engineering at the State Polytechnic of Indramayu
						</p>
					</div>
					<p class="primary-btn" data-text="About Myself">
						<span>A</span>
						<span>b</span>
						<span>o</span>
						<span>u</span>
	...
	<section class="job-area section-gap-top section-gap-bottom-90">
		<div class="container">
			<div class="row d-flex">
				<div class="col-lg-12">
					<div class="section-title">
						<h2><span class="fas fa-graduation-cap"> Education</h2>
					</div>
				</div>
			</div>
				...
				<!-- <div class="col-lg-6">
					<div class="single-job">
						<div class="top-sec d-flex justify-content-between">
							<div class="top-left">
								<h4>Kindergarden</h4>
								<p>at TK Nurhidayatullah, Cirebon</p>
							</div>
							<div class="top-right">
								<p class="primary-btn" data-text="Since 2004 - 2005">
	...
	<section class="service-area section-gap">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="section-title">
						<h2><span class="fas fa-award"></span> Experience</h2>
					</div>
				</div>
			</div>
			<div class="row">
  ...
  <div class="container">
    <div class="section-top-border">
      <h2 class="mb-30"><span class="fas fa-bolt"></span> Skill</h2>
      <div class="progress-table-wrap">
        <div class="progress-table">
          ...
          <div class="table-row">
            ...
            <div class="country"> <img src="img/html.png" alt=""> HTML</div>
          ...
          <div class="table-row">
            ...
            <div class="country"> <img src="img/css.png" alt=""> CSS</div>
            <div class="visit">Frontend</div>
            <div class="percentage">
              <div class="progress">
          ...
          <div class="table-row">
            ...
            <div class="country"> <img src="img/js.png" alt=""> Javascript</div>
            <div class="visit">Frontend</div>
            <div class="percentage">
              <div class="progress">
                <div class="progress-bar color-2" role="progressbar" style="width: 50%" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
          </div>
          <!-- <div class="table-row">
          ...
          <div class="table-row">
            ...
            <div class="percentage">
              <div class="progress">
                <div class="progress-bar color-1" role="progressbar" style="width: 85%" aria-valuenow="85" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
          </div>
          <div class="table-row">
          ...
          <div class="table-row">
            ...
            <div class="percentage">
              <div class="progress">
                <div class="progress-bar color-1" role="progressbar" style="width: 45%" aria-valuenow="45" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
          </div>
          <div class="table-row">
          ...
          <div class="table-row">
            ...
            <div class="percentage">
              <div class="progress">
                <div class="progress-bar color-2" role="progressbar" style="width: 35%" aria-valuenow="35" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
          </div>
          <div class="table-row">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="contact-title">
						<h2><span class="fas fa-mobile-alt"></span> Contact Me</h2>
					</div>
				</div>
			</div>
			...
			<div class="row mt-80">
				<div class="col-lg-4 col-md-4">
					<div class="contact-box">
						<h4>(+62)89 677 471 833</h4>
					</div>
				</div>
				<div class="col-lg-4 col-md-4">
					<div class="contact-box">
						<h4>m.salehidris13@gmail.com</h4>
					</div>
				</div>
				<div class="col-lg-4 col-md-4">
					<div class="contact-box">
			...
			<div class="row">
				<div class="col-lg-12 text-center">
					<p class="primary-btn mt-40" data-text="Contact Me">
						<span>C</span>
						<span>o</span>
						<span>n</span>
						<span>t</span>
